...
#from model_zoo.mambairv2 import buildMambaIRv2Base
...
confi_file_root_path = '../options/test_SFIMLLIE_LOLv1.yml'
...
# copied from https://github.com/DingXiaoH/RepLKNet-pytorch
def visualize_erf(MODEL: nn.Module = None, num_images=15, data_path="/data/lgl/datasets/LOLdataset",
...
if __name__ == '__main__':
    ...
    init_model = buildSFIMLLIE()
    ckpt_path = '/data/lgl/codes/LowlightMOEMaIR/realDenoising/experiments/MambaIR_SFIMLLIE_LOLv1/models/net_g_latest.pth' # path to load your pre_trained model weights
