...
class MaIRUNetFBEnhancedPolarFSMDSConvIllumSSA(nn.Module):
    def __init__(self,
                 img_size=64,
                 patch_size=1,
                 ssm_ratio=1.5,
        ...
        super(MaIRUNetFBEnhancedPolarFSMDSConvIllumSSA, self).__init__()
...
if __name__ == '__main__':
    height = 64
    width = 64
    model = MaIRUNetFBEnhancedPolarFSMDSConvIllumSSA(
        inp_channels=3,
        out_channels=3,
        dim=48,
        num_blocks=[4, 6, 6, 8],
